...
struct User {
    ...
    static var currentUser = User(userName: "Coonnar", email: "c.mordelt@student.xu-university.de", age: 23)
 ...
 */
User.logIn(user: User(userName: "Floh", email: "flo@student.xu-university.de", age: 20))
